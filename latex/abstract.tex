...
Given a COP modeled with MiniZinc, \tool first analyzes the model to decide whether the problem is efficiently solvable with DP. If so, 
\tool refactors the constraints and objective functions to model the problem as a DP problem.
