...
%Branch-and-bound search prunes unpromising paths if a partial solution tree can never lead to a solution better than the existing known optimum (i.e., bound)~\cite{marinescu2005and}. 
